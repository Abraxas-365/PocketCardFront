...
<div class="relative mx-auto max-w-xl flex flex-col min-h-screen">
	...
	<div class="px-5 relative z-10 mt-[-23rem] flex-grow flex flex-col">
		...
		<div class="rounded-full overflow-hidden w-52 h-52 mx-auto flex justify-center items-center">
			<div class="absolute w-64 h-64 rounded-full -z-10" style="background-color: {accentColor};" />
